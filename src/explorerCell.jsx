...
class ExplorerCell extends React.Component {
    ...
    return (
      <div className="x_panel fixed_height_180">
        <div className="x_title">
          <button type="button" className="btn btn-round btn-warning">43b66168af6fd87fed9e360d83bc87ebc1fce8f91c737c353f986823a7ea32f7</button>
        ...
        <button type="button" className="pull-right btn btn-round btn-primary">215 Confirmation</button>
        <button type="button" className="pull-right btn btn-round btn-success">100 Satoshis</button>
      </div>
    );
  }
  ...
  renderBlocks() {
    return (
      <div className="x_panel fixed_height_180">
        <div className="x_title">
          <button type="button" className="btn btn-round btn-warning">{this.props.blockHash}</button>
          <h2 className="pull-right">04/03/2017 07:31:39</h2>
          <div className="clearfix" />
        </div>
        <button type="button" className="pull-right btn btn-round btn-primary">{this.props.transactionAmount} Transactions</button>
        <button type="button" className="pull-right btn btn-round btn-success">{this.props.blockSize} Bytes</button>
        <button type="button" className="pull-right btn btn-round btn-info"># {this.props.blockHeight}</button>
      </div>
    );
  }
